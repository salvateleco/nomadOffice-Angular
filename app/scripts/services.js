...
//.constant("baseURL", "https://localhost:3443/") // Using local server
.constant("baseURL", "https://nomadofficeapp.eu-gb.mybluemix.net/") // Using secure server on Bluemix
.factory('menuFactory', ['$resource', 'baseURL', function ($resource, baseURL) {

        return $resource(baseURL + "places/:id", null, {'update': {method: 'PUT'}});

}])

.factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {

        return $resource(baseURL + "places/:id/comments/:commentId",
                         {id:"@Id", commentId: "@CommentId"}, {'update': {method: 'PUT'}});
